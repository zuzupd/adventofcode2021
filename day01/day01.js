...
function sonarTest(val, expected) {
  console.log("test result for sonar function: " + (sonar(val) == expected));
}

function bandTest(val, length, expected) {
  console.log("test result is for band function: " + (band(val).length == length));
...
console.log(
  "Part 1: The number of times a depth measurement increases: " + sonar(depths)
);
console.log(
